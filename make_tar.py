...
openttd_path = "C:/Users/tyler/Documents/OpenTTD/game"
...
if(mainversion == -1 or subversion == -1):
    print("Couldn't find " + gs_pack_name + " version in info.nut!")
    exit(-1)

tmp_dir = gs_pack_name + "-" + str(mainversion) + "." + str(subversion)
